...
public class TestDb extends AndroidTestCase {
    ...
    public void testCreateDb() throws Throwable {
        ...
        tableNameHashSet.add(MovieSelectEntry.TABLE_NAME);
        ...
        c = db.rawQuery("PRAGMA table_info(" + MovieInfoEntry.TABLE_NAME + ")",
                null);
        ...
        //locationColumnHashSet.add(MovieInfoEntry.COL_MV_NAME);
        locationColumnHashSet.add(MovieInfoEntry.COL_MV_POSTER_LINK);
        locationColumnHashSet.add(MovieInfoEntry.COL_MV_VIDEO_LINK);
        locationColumnHashSet.add(MovieInfoEntry.COL_MV_KEY);
        //locationColumnHashSet.add(MovieInfoEntry.COL_MV_GROUP);
...
//        long dynamicPRowId = db.insert(MovieContract.MovieSelectEntry.TABLE_NAME, null, dynamicPValues);
//        assertTrue(dynamicPRowId != -1);
//
//        // Fourth Step: Query the database and receive a Cursor back
//        // A cursor is your primary interface to the query results.
//        Cursor movieCursor = db.query(
//                MovieContract.MovieSelectEntry.TABLE_NAME,  // Table to Query
...
//        long movieRowId;
//        movieRowId = db.insert(MovieContract.MovieInfoEntry.TABLE_NAME, null, testValues);
//
