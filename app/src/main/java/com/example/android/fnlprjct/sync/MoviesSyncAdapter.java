...
//import com.example.android.myproject_2.data.MovieContract.MovieReviewEntry;
//import com.example.android.myproject_2.data.MovieContract.MovieVideosEntry;
...
//        Uri buildUri; // = null;
        ...
        try {
            ...
            /********************************************************/
            // (1)
            uri = Utility.formUri_MovieInfo(mContext);
         // uri = formUri_MovieInfo();
...
//
//                contentValues.put(MovieVideosEntry.COL_VIDEO_KEY, aMovieKey);
//                contentValues.put(MovieVideosEntry.COL_MV_ID, movieId);
//
//                getContext().getContentResolver()
//                    .insert(MovieVideosEntry.CONTENT_URI, contentValues);
//            }
//        }
//
//    }
...
//            contentValues.put(MovieReviewEntry.COL_REVIEWER, movieReviewer);
//            contentValues.put(MovieReviewEntry.COL_REVIEWCONTENT, movieReviewContent);
//
//            //+++++++++++++++++++----------------
//
//            //+++++++++++++++++++----------------
...
//                .insert(MovieReviewEntry.CONTENT_URI,
//                        contentValues
//                        //cv
//                );
//    }
